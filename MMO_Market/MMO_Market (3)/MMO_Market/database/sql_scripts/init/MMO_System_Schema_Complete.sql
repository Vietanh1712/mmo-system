...
CREATE TABLE Users (
    ...
    deposit_vnd BIGINT NOT NULL DEFAULT 500000, -- Phí mở shop (tiền cọc)
...
INSERT INTO Users (id, email, password, full_name, gender, address, national_id, date_of_birth, role, phone, shop_status, balance_vnd, deposit_vnd, isVerified, isLocked, isDelete)
VALUES
(1, 'netflixvn@mmo.com', @PasswordHash, N'NetflixVN Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0901111111', 'Approved', 1500000, 500000, 1, 0, 0),
(2, 'netflixvip@mmo.com', @PasswordHash, N'Netflix_Vip_Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0902222222', 'Approved', 4500000, 500000, 1, 0, 0),
(3, 'aihelper@mmo.com', @PasswordHash, N'AI_Helper Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0903333333', 'Approved', 1200000, 500000, 1, 0, 0),
(4, 'musiclovers@mmo.com', @PasswordHash, N'MusicLovers Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0904444444', 'Approved', 800000, 500000, 1, 0, 0),
(5, 'microsoft@mmo.com', @PasswordHash, N'Microsoft_Reseller Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0905555555', 'Approved', 6200000, 500000, 1, 0, 0),
(6, 'redpremium@mmo.com', @PasswordHash, N'RedPremium Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0906666666', 'Approved', 950000, 500000, 1, 0, 0),
(7, 'canvapro@mmo.com', @PasswordHash, N'CanvaPro Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0907777777', 'Approved', 3200000, 500000, 1, 0, 0),
(8, 'gmailpro@mmo.com', @PasswordHash, N'GmailPro Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0908888888', 'Approved', 110000, 500000, 1, 0, 0),
(9, 'mmocoder@mmo.com', @PasswordHash, N'MMO_Coder Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0909999999', 'Approved', 8500000, 500000, 1, 0, 0),
(10, 'securenet@mmo.com', @PasswordHash, N'SecureNet Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0901234567', 'Approved', 720000, 500000, 1, 0, 0),
(11, 'socialmediaup@mmo.com', @PasswordHash, N'SocialMediaUp Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0902345678', 'Approved', 210000, 500000, 1, 0, 0),
(12, 'bannerdesign@mmo.com', @PasswordHash, N'BannerDesign Store', NULL, NULL, NULL, NULL, '{"role": "Seller"}', '0903456789', 'Approved', 0, 500000, 1, 0, 0),
(13, 'customer01@gmail.com', @PasswordHash, N'Nguyễn Văn Khách', N'Nam', N'123 Đường Nguyễn Trãi, Hà Nội', '001096001234', '1996-05-15', '{"role": "Customer"}', '0987654321', 'Pending', 50000000, 0, 1, 0, 0),
(14, 'staff01@gmail.com', @PasswordHash, N'Trần Thị Nhân Viên', N'Nữ', N'456 Cầu Giấy, Hà Nội', '001098005678', '1998-08-20', '{"role": "Staff"}', '0912345678', 'Approved', 0, 0, 1, 0, 0),
(15, 'admin01@gmail.com', @PasswordHash, N'Admin MMO System', N'Nam', N'Hệ thống MMO Market', '001090009999', '1990-01-01', '{"role": "Admin"}', '0900000000', 'Approved', 0, 0, 1, 0, 0),
(16, 'admin@mmo.com', '$2a$10$NcmOXXGkICk.davDnIvgbuUcscMw31mHDhb5oei/4hHOaWZRzE.g6', N'Administrator', N'Nam', N'Hệ thống MMO Market', '001090000000', '1990-01-01', '{"role": "Admin"}', '0123456789', 'Approved', 0, 0, 1, 0, 0);
