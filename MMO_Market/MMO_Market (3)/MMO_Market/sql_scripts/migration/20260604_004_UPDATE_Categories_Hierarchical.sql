...
VALUES
    (N'Email', NULL, N'Các dịch vụ email và tài khoản mail', 0),                          -- ID: 1
    (N'Tài khoản', NULL, N'Tài khoản các nền tảng xã hội & dịch vụ', 0),                 -- ID: 2
    (N'Phần mềm', NULL, N'Các công cụ phần mềm chuyên dụng cho kinh doanh online', 0),   -- ID: 3
    (N'Tăng tương tác', NULL, N'Các dịch vụ tăng engagement & tương tác trên mạng xã hội', 0),  -- ID: 4
    (N'Dịch vụ phần mềm', NULL, N'Công cụ, plugin và dịch vụ lập trình', 0),             -- ID: 5
    (N'Blockchain', NULL, N'Các sản phẩm tiền ảo, NFT và blockchain', 0);                -- ID: 6
