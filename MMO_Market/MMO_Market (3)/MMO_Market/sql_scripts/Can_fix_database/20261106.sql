...
-- ==========================================
2. CHÈN DỮ LIỆU KHÁCH HÀNG MỚI ĐỂ ĐÁNH GIÁ & GIAO DỊCH
-- ==========================================
SET IDENTITY_INSERT Users ON;
INSERT INTO Users (id, email, password, full_name, gender, address, national_id, date_of_birth, role, phone, shop_status, balance_vnd, isVerified, isLocked, isDelete)
VALUES
(17, 'customer02@gmail.com', '$2a$10$NcmOXXGkICk.davDnIvgbuUcscMw31mHDhb5oei/4hHOaWZRzE.g6', N'Lê Minh Tuấn', N'Nam', N'Hà Nội', NULL, NULL, '{"role": "Customer"}', '0911222333', 'Pending', 1000000, 1, 0, 0),
(18, 'customer03@gmail.com', '$2a$10$NcmOXXGkICk.davDnIvgbuUcscMw31mHDhb5oei/4hHOaWZRzE.g6', N'Phạm Thanh Thảo', N'Nữ', N'TP Hồ Chí Minh', NULL, NULL, '{"role": "Customer"}', '0922333444', 'Pending', 2000000, 1, 0, 0),
(19, 'customer04@gmail.com', '$2a$10$NcmOXXGkICk.davDnIvgbuUcscMw31mHDhb5oei/4hHOaWZRzE.g6', N'Hoàng Đức Hải', N'Nam', N'Đà Nẵng', NULL, NULL, '{"role": "Customer"}', '0933444555', 'Pending', 500000, 1, 0, 0),
(20, 'customer05@gmail.com', '$2a$10$NcmOXXGkICk.davDnIvgbuUcscMw31mHDhb5oei/4hHOaWZRzE.g6', N'Nguyễn Bích Vân', N'Nữ', N'Hải Phòng', NULL, NULL, '{"role": "Customer"}', '0944555666', 'Pending', 1500000, 1, 0, 0);
SET IDENTITY_INSERT Users OFF;
GO

-- ==========================================
3. CHÈN DỮ LIỆU GIAO DỊCH MẪU (TRANSACTIONS) ĐỂ TÍNH LƯỢT BÁN
-- ==========================================
...
VALUES
-- Product 1 (Netflix 1 Month, price 65000, seller 1) - 6 sales
(13, 1, 1, 1, 65000, 6500, 'Completed', GETDATE(), GETDATE(), 0),
(17, 1, 1, 1, 65000, 6500, 'Completed', GETDATE(), GETDATE(), 0),
(18, 1, 1, 1, 65000, 6500, 'Completed', GETDATE(), GETDATE(), 0),
(19, 1, 1, 1, 65000, 6500, 'Completed', GETDATE(), GETDATE(), 0),
(20, 1, 1, 1, 65000, 6500, 'Completed', GETDATE(), GETDATE(), 0),
(13, 1, 1, 1, 65000, 6500, 'Completed', GETDATE(), GETDATE(), 0),

-- Product 2 (Netflix 1 Year, price 650000, seller 2) - 4 sales
(13, 2, 2, 2, 650000, 65000, 'Completed', GETDATE(), GETDATE(), 0),
(17, 2, 2, 2, 650000, 65000, 'Completed', GETDATE(), GETDATE(), 0),
(18, 2, 2, 2, 650000, 65000, 'Completed', GETDATE(), GETDATE(), 0),
(19, 2, 2, 2, 650000, 65000, 'Completed', GETDATE(), GETDATE(), 0),

-- Product 3 (ChatGPT Plus, price 150000, seller 3) - 5 sales
(17, 3, 3, 3, 150000, 15000, 'Completed', GETDATE(), GETDATE(), 0),
(18, 3, 3, 3, 150000, 15000, 'Completed', GETDATE(), GETDATE(), 0),
(19, 3, 3, 3, 150000, 15000, 'Completed', GETDATE(), GETDATE(), 0),
(20, 3, 3, 3, 150000, 15000, 'Completed', GETDATE(), GETDATE(), 0),
(13, 3, 3, 3, 150000, 15000, 'Completed', GETDATE(), GETDATE(), 0),

-- Product 4 (Spotify Premium, price 250000, seller 4) - 3 sales
(18, 4, 4, 4, 250000, 25000, 'Completed', GETDATE(), GETDATE(), 0),
(19, 4, 4, 4, 250000, 25000, 'Completed', GETDATE(), GETDATE(), 0),
(20, 4, 4, 4, 250000, 25000, 'Completed', GETDATE(), GETDATE(), 0),

-- Product 5 (Windows 11 Pro Key, price 99000, seller 5) - 7 sales
(13, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),
(17, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),
(18, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),
(19, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),
(20, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),
(13, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),
(17, 5, 5, 5, 99000, 9900, 'Completed', GETDATE(), GETDATE(), 0),

-- Product 6 (Youtube Premium, price 120000, seller 6) - 5 sales
(17, 6, 6, 6, 120000, 12000, 'Completed', GETDATE(), GETDATE(), 0),
(18, 6, 6, 6, 120000, 12000, 'Completed', GETDATE(), GETDATE(), 0),
(19, 6, 6, 6, 120000, 12000, 'Completed', GETDATE(), GETDATE(), 0),
(20, 6, 6, 6, 120000, 12000, 'Completed', GETDATE(), GETDATE(), 0),
(13, 6, 6, 6, 120000, 12000, 'Completed', GETDATE(), GETDATE(), 0);
GO

-- ==========================================
4. CHÈN DỮ LIỆU ĐÁNH GIÁ MẪU (REVIEWS) TIẾNG VIỆT
-- ==========================================
INSERT INTO Reviews (product_id, user_id, rating, comment, created_at, isDelete)
VALUES
-- Product 1 (Netflix 1 Month)
(1, 13, 5, N'Tài khoản xem rất mượt, giao hàng siêu nhanh, cám ơn shop!', GETDATE(), 0),
(1, 17, 5, N'Dịch vụ tốt, tài khoản ổn định chất lượng 4k nét căng.', GETDATE(), 0),
(1, 18, 4, N'Tài khoản xem ok, lúc đầu bị lỗi đăng nhập nhưng shop hỗ trợ nhiệt tình đã sửa được.', GETDATE(), 0),

-- Product 2 (Netflix 1 Year)
(2, 13, 5, N'Mua gói 1 năm dùng quá tiết kiệm, dùng 3 tháng rồi vẫn rất ổn định.', GETDATE(), 0),
(2, 19, 5, N'Rất hài lòng với chất lượng dịch vụ của shop. Uy tín!', GETDATE(), 0),

-- Product 3 (ChatGPT Plus)
(3, 17, 5, N'Tài khoản GPT-4o dùng siêu mượt, hỗ trợ công việc viết lách rất tốt.', GETDATE(), 0),
(3, 20, 4, N'Dùng tốt, thỉnh thoảng mạng hơi chậm nhưng chấp nhận được.', GETDATE(), 0),

-- Product 4 (Spotify Premium)
(4, 18, 5, N'Gia hạn nhanh chóng, nghe nhạc chất lượng cao không quảng cáo.', GETDATE(), 0),

-- Product 5 (Windows 11 Pro Key)
(5, 13, 5, N'Key kích hoạt thành công ngay lập tức. Cảm ơn shop!', GETDATE(), 0),
(5, 19, 5, N'Active vĩnh viễn đúng mô tả, giá rẻ hơn các chỗ khác rất nhiều.', GETDATE(), 0),

-- Product 6 (Youtube Premium)
(6, 17, 5, N'Xem không quảng cáo rất thích, shop add family nhanh.', GETDATE(), 0);
GO
