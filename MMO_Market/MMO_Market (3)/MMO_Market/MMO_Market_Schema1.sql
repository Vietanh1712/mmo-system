...
CREATE TABLE Products (
    ...
    product_type NVARCHAR(20) NOT NULL DEFAULT 'ACCOUNT', 
    created_at DATETIME DEFAULT GETDATE(),
    isDelete BIT DEFAULT 0,  
    is_delete BIT DEFAULT 0, 
...
-- ==========================================
-- PHẦN 4: GIAO DỊCH VÀ VÍ ĐIỆN TỬ
-- ==========================================
...
CREATE TABLE Notifications (
    ...
    created_at DATETIME DEFAULT GETDATE(),
    isDelete BIT DEFAULT 0,
    [status] NVARCHAR(20) NOT NULL CONSTRAINT [DF_Notifications_status] DEFAULT N'PUBLISHED',
...
UPDATE Users SET shop_status = 'Active', balance_vnd = 25000000 WHERE id = 2;
