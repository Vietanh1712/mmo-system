...
(13, N'Góp ý', N'Góp ý thêm tính năng thanh toán MoMo', N'Sàn nên tích hợp thêm cổng thanh toán MoMo để người dùng có nhiều lựa chọn nạp tiền hơn.', 'Replied', N'Cảm ơn bạn đã góp ý. Hệ thống đang lên kế hoạch tích hợp MoMo vào quý sau.', DATEADD(day, -1, GETDATE()), 0),
...
(13, N'Lỗi nạp tiền', N'Chuyển khoản sai nội dung giao dịch', N'Tôi chuyển khoản nạp tiền nhưng quên nhập mã giao dịch trong nội dung. Mã SePay của tôi là SP123456.', 'Closed', N'Đã cộng tay thủ công cho user thành công.', DATEADD(day, -3, GETDATE()), 0);
GO
