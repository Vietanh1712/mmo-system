...
```
┌────────────────────────────────────────────────────────────────────────┐
│  CẤU HÌNH HỆ THỐNG                                           [ 💾 Lưu ] │
├────────────────────────────────────────────────────────────────────────┤
│  Tham số vận hành                                                      │
│  * Thời gian phiên (phút):             [ 15 ]                          │
...
* Chứa các ô nhập kiểu số đại diện cho: thời gian session, thời gian OTP, giới hạn đăng nhập sai, thời gian lock tài khoản, số giờ giam tiền escrow.
...
2. **Lưu cấu hình hệ thống chung:**
   * Admin nhấn "Lưu" ở view cấu hình hệ thống.
