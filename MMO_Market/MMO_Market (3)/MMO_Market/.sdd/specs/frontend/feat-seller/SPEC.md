...
| FR-SELL-06 | WHEN the seller's shop is in "Suspended" (Tạm ngưng), "Locked" (Tạm khóa), "Banned" (Khóa vĩnh viễn), or "Withdrawn" (Đã đóng Shop) status, THE SYSTEM SHALL display a red alert notice at the top of the post product page and disable all input fields and submit button to prevent new product listings. |