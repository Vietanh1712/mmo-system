...
public interface ComplaintService {
    ...
    Complaint updateComplaintStatus(Long complaintId, String status, String resolution, String flagLevel, String flagReason, String suspendedUntil, Long staffId);
